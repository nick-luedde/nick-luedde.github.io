...
<section in:fade class="container max-w-screen-lg m-auto">
  <section class="container max-w-screen-lg m-auto">
    ...
    <p>
      ...
      <br />
      <a
        href="https://github.com/nick-luedde/ipt"
        target="_blank"
    ...
    <p class="mb-11">
      Here is a sample app running all client side with a mock server. In an
      AppsScript deployment it has a complete server component.
    </p>
  </section>

  <section class="w-full h-[calc(100vh-70px)] px-2">
    <div class="border w-full h-full border-white">
      <iframe title="Project example" class="w-full h-full" src="/ipt.html"
      ></iframe>
    </div>
  </section>
</section>
