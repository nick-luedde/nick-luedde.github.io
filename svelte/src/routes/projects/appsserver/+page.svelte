...
<section in:fade>
  ...
  <div class="flex flex-col md:flex-row gap-3">
    ...
    >
      ...
      <p>
        ...
        = <span class="text-green-400">Date</span>.<span class="text-yellow-200"
          >now</span
        >();
        <span class="text-blue-200">res</span>.<span class="text-yellow-200"
          >headers</span
        >({"{"} <span class="text-red-300">'app-response-time'</span>:
        <span class="text-blue-200">end</span>
        - <span class="text-blue-200">start</span>
        {"}"});
        {"}"});
      ...
      <p>
        ...
        = [
        {"{"} id: 1, task:
        <span class="text-red-300">'Build a sweet portfolio'</span>, done:
        <span class="text-blue-400">false</span>
        {"}"},
        {"{"} id: 2, task: <span class="text-red-300">'Drink coffee'</span>,
        done:
      ...
      <p>
        ...
        = <span class="text-blue-200">req</span>.<span class="text-blue-200"
          >body</span
        >;
        <span class="text-blue-200">console</span>.<span class="text-yellow-200"
          >log</span
        >(<span class="text-blue-200">task</span>);
      ...
      <p>
        ...
        >({"{"}
        method: <span class="text-red-300">'get'</span>, route:
      ...
      <p>
        ...
        = <span class="text-blue-200">server</span>.<span
          class="text-yellow-200">request</span
        >({"{"}
        method: <span class="text-red-300">'post'</span>, route:
        <span class="text-red-300">'/task/save'</span>, body: {"{"} id: 2, task:
        <span class="text-red-300">'Build a sweet portfolio'</span>, done:
        <span class="text-blue-400">true</span>
        {"}"}
        {"}"});
    ...
    <article
      id="runner"
      class="flex-1 rounded-xl bg-black border border-white transition-colors duration-700"
    >
      <div class="flex">
        <button
          id="tasks"
